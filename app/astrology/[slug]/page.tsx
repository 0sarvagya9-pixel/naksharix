    ...
    <main className="star-field">
      ...
      <Section>
        <div className="grid gap-10 lg:grid-cols-[1fr_0.72fr]">
          <div>
            <p className="inline-flex rounded-full border border-amber-200/30 bg-amber-200/10 px-4 py-2 text-sm font-semibold text-amber-100">
              {page.keyword}
            </p>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {page.related.map((item) => (
            <Card key={item} className="border-amber-200/15 bg-card/70">
              <CardHeader>
