            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <Card className="border-amber-200/15 bg-card/70">
                <CardContent className="p-5">
                  ...
                  <p className="text-sm text-muted-foreground">Primary support email</p>
                </CardContent>
              </Card>
              <Card className="border-amber-200/15 bg-card/70">
                <CardContent className="p-5">
          ...
          <Card className="glass">
            ...
            <CardContent>
              <form className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Contact form delivery is placeholder-ready. Email us directly for production support.</p>
              </form>
            </CardContent>
          </Card>
        </div>
