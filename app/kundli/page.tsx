  ...
  return (
    <main>
      <Section>
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">Generate planets, houses, lagna, navamsa, dashas, yogas, doshas, manglik analysis, panchang details, and PDF-ready report data.</p>
        <div className="mt-8">
          <KundliForm />
        </div>
      </Section>
