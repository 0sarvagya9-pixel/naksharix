      ...
      <Section>
        <div className="inner-section rounded-3xl border border-[#263957] p-6 text-center md:p-10">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#a8b3c7]">
            Accurate Panchang depends on date, location, timezone, sunrise, sunset, moonrise, moonset, lunar position, tithi, nakshatra, yoga, karana, Vaar, Rahu Kaal, Yamaganda, Gulika Kaal, and Abhijit Muhurat.
          </p>
