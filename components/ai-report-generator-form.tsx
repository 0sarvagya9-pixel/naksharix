...
export function AiReportGeneratorForm() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
      <form action={generate} className="space-y-4 rounded-lg border border-amber-200/15 bg-card/60 p-5">
        ...
        <Field label="Language">
          <select name="language" defaultValue="English" className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm">
      ...
      <div className="min-h-80 whitespace-pre-line rounded-lg border border-amber-200/15 bg-card/60 p-5 text-sm leading-7 text-muted-foreground">
