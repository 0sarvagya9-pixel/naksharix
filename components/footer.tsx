      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:py-12">
        <div className="grid gap-8 lg:grid-cols-[1.4fr_2.6fr]">
          <div className="max-w-sm">
            ...
            <p className="mt-3 text-xs leading-6" style={{ color: "#676d7a" }}>
              Astrology, numerology, tarot, and consultations are provided for reflection and general guidance. They are not guaranteed outcomes or professional advice.
            </p>
          </div>

          <nav aria-label="Footer navigation" className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
            {groups.map((group) => (
              <div key={group.title}>
                <p
        ...
        >
          ...
          <p style={{ fontSize: 11, color: "#525866" }}>
            Digital reports and consultations · Payments processed through Razorpay
          </p>
        </div>
      </div>
    </footer>
    ...
    return [
      {
        ...
        links: [
          ...
          ["मुफ़्त कैलकुलेटर", "/free-calculators"],
          ["टैरो", "/tarot"],
        ],
      },
      {
      ...
      },
      {
        title: "सेवाएँ",
        links: [
          ["प्रीमियम रिपोर्ट", "/reports"],
          ["ज्योतिषी", "/astrologers"],
          ["परामर्श", "/consultation"],
          ["सेव की गई रिपोर्ट", "/saved-reports"],
          ["मेरी बुकिंग", "/dashboard/bookings"],
        ],
      },
      {
        title: "सहायता",
