...
export function VedicNorthIndianChart({
  ...
  return (
    <section className={cn("rounded-2xl border border-amber-200/20 bg-[#160a28] p-4 shadow-[0_22px_70px_rgba(5,2,14,0.34)]", className)}>
      <div className="mb-3 flex items-center justify-between gap-3">
        <div>
          <h3 className="font-cinzel text-xl font-black text-amber-50">{title}</h3>
        ...
        <span className="rounded-full border border-amber-200/30 bg-amber-200/12 px-3 py-1 text-xs font-bold text-amber-100">D1</span>
      </div>
