...
const copy: Record<Locale, Record<TrustPageKey, TrustCopy>> = {
  en: {
    about: {
      ...
      intro: "Naksharix brings provider-calculated Vedic astrology, Kundli, matching, numerology, Lo Shu, tarot, and reflective guidance into one calm premium experience.",
      ...
      sections: [
        { title: "What Naksharix Is", body: "Naksharix is a spiritual-tech platform for people who want clearer self-reflection through astrology, numerology, tarot, matching, and report workflows." },
        { title: "Our Approach", body: "We design guidance as a planning and reflection tool. Reports and calculated outputs are meant to support awareness, not replace practical judgment or qualified professional advice." },
        { title: "Trust Promise", body: "We avoid fear-based claims, promised outcomes, and extreme recommendations. When information is incomplete, Naksharix should say so clearly." }
      ],
      ctaTitle: "Need help?",
    ...
    contact: {
      ...
      intro: "For report questions, account help, or product feedback, contact us directly.",
      badge: "Support",
    ...
    privacy: {
      ...
      badge: "Privacy",
      highlights: ["Birth details power chart calculations", "Held modules stay disabled until ready", "Language and session preferences may use local storage"],
      sections: [
        ...
        { title: "How We Use Data", body: "Information is used to generate Kundli, matching, numerology, Lo Shu, tarot reflections, report workflows, support replies, and product safety improvements." },
        { title: "Held Module Use", body: "AI Astrologer remains on hold. If it is activated later, its data handling will be explained before production use." },
    ...
    terms: {
      ...
      intro: "These terms explain the responsible use of Naksharix guidance, tools, reports, and content.",
      badge: "Terms",
      highlights: ["Guidance, not promises", "User-entered data must be accurate", "Held modules may be unavailable"],
      sections: [
        { title: "Use of Service", body: "Naksharix provides astrology, numerology, tarot, matching, reports, and reflective guidance for planning." },
        ...
        { title: "Module Limitations", body: "Held or beta modules may be unavailable. Use practical judgment and seek qualified help where needed." },
    ...
    disclaimer: {
      ...
      badge: "Important",
      highlights: ["No promised outcomes", "Not medical, legal, financial, or psychological advice", "Critical decisions need practical review"],
      sections: [
        { title: "Guidance Scope", body: "Astrology, numerology, tarot, and report guidance on Naksharix are for reflection, spiritual insight, and general guidance." },
        ...
        { title: "Held Modules", body: "AI Astrologer and other held modules are not production guidance surfaces in this phase." }
      ],
  ...
  hi: {
    about: {
      ...
      intro: "Naksharix provider-calculated वैदिक ज्योतिष, कुंडली, मिलान, अंक ज्योतिष, लो शू, टैरो और चिंतनात्मक मार्गदर्शन को एक प्रीमियम अनुभव में जोड़ता है।",
      badge: "वैदिक ज्योतिष",
      highlights: ["वैदिक कुंडली और दशा संदर्भ", "अंक ज्योतिष और लो शू अंतर्दृष्टि", "English, Hindi और Hinglish समर्थन"],
      sections: [
        { title: "Naksharix क्या है", body: "Naksharix एक spiritual-tech प्लेटफ़ॉर्म है जो ज्योतिष, अंक ज्योतिष, टैरो, मिलान और report workflows के माध्यम से आत्मचिंतन में सहायता करता है।" },
        { title: "हमारा दृष्टिकोण", body: "हम मार्गदर्शन को योजना और चिंतन का साधन मानते हैं। रिपोर्ट और calculated outputs व्यावहारिक निर्णय या योग्य पेशेवर सलाह का विकल्प नहीं हैं।" },
    ...
    contact: {
      ...
      intro: "रिपोर्ट, account help या product feedback के लिए हमें सीधे संपर्क करें।",
      badge: "सपोर्ट",
    ...
    privacy: {
      ...
      badge: "गोपनीयता",
      highlights: ["जन्म विवरण chart calculations में मदद करते हैं", "Held modules ready होने तक disabled रहते हैं", "Language और session preferences browser storage में रह सकती हैं"],
      sections: [
        ...
        { title: "डेटा का उपयोग", body: "जानकारी Kundli, matching, numerology, Lo Shu, tarot reflections, report workflows, support replies और product safety improvement के लिए उपयोग होती है।" },
        { title: "Held module उपयोग", body: "AI Astrologer hold पर है। Future activation होने पर production use से पहले data handling साफ बताई जाएगी।" },
    ...
    terms: {
      ...
      intro: "ये terms Naksharix guidance, tools, reports और content के जिम्मेदार उपयोग को समझाते हैं।",
      badge: "Terms",
      highlights: ["Guidance है, promise नहीं", "User-entered data सही होना चाहिए", "Held modules unavailable हो सकते हैं"],
      sections: [
        { title: "सेवा का उपयोग", body: "Naksharix reflection और planning के लिए astrology, numerology, tarot, matching, reports और reflective guidance देता है।" },
        ...
        { title: "No promised results", body: "Naksharix marriage, career, health, finance, legal या personal outcomes की guarantee नहीं देता।" },
        { title: "Module limitations", body: "Held या beta modules unavailable हो सकते हैं। Practical judgment और qualified help जरूरी हो सकती है।" },
    ...
    disclaimer: {
      ...
      badge: "महत्वपूर्ण",
      highlights: ["कोई promised outcome नहीं", "Medical, legal, financial या psychological advice नहीं", "Critical decisions में practical review जरूरी है"],
      sections: [
        { title: "Guidance scope", body: "Naksharix पर astrology, numerology, tarot और report guidance reflection, spiritual insight और general guidance के लिए है।" },
        ...
        { title: "Held modules", body: "AI Astrologer और दूसरे held modules इस phase में production guidance surface नहीं हैं।" }
      ],
  ...
  hinglish: {
    about: {
      ...
      intro: "Naksharix provider-calculated Vedic astrology, Kundli, matching, numerology, Lo Shu, tarot aur reflective guidance ko ek premium experience me laata hai.",
      badge: "Vedic Astrology",
      highlights: ["Vedic Kundli aur Dasha context", "Numerology aur Lo Shu insights", "English, Hindi aur Hinglish support"],
      sections: [
        { title: "Naksharix kya hai", body: "Naksharix ek spiritual-tech platform hai jo astrology, numerology, tarot, matching aur report workflows ke through self-reflection support karta hai." },
        { title: "Humara approach", body: "Guidance ko planning aur reflection tool maana gaya hai. Reports aur calculated outputs practical judgment ya professional advice ka replacement nahi hain." },
        { title: "Trust promise", body: "Hum fear-based claims, promised outcomes aur extreme recommendations se bachkar clear, calm guidance dete hain." }
      ],
    ...
    contact: {
      ...
      intro: "Report questions, account help ya product feedback ke liye direct contact karein.",
      badge: "Support",
    ...
    privacy: {
      ...
      badge: "Privacy",
      highlights: ["Birth details chart calculation me help karte hain", "Held modules ready hone tak disabled rehte hain", "Language/session preferences local storage me reh sakti hain"],
      sections: [
        ...
        { title: "Data use", body: "Data Kundli, matching, numerology, Lo Shu, tarot reflections, report workflows, support replies aur product safety improvements ke liye use hota hai." },
        { title: "Held module use", body: "AI Astrologer hold par hai. Future activation hone par production use se pehle data handling clearly explain ki jayegi." },
    ...
    terms: {
      ...
      intro: "Yeh terms Naksharix guidance, tools, reports aur content ka responsible use explain karte hain.",
      badge: "Terms",
      highlights: ["Guidance hai, promise nahi", "Entered data accurate hona chahiye", "Held modules unavailable ho sakte hain"],
      sections: [
        { title: "Use of service", body: "Naksharix reflection aur planning ke liye astrology, numerology, tarot, matching, reports aur reflective guidance provide karta hai." },
        ...
        { title: "No promised results", body: "Naksharix marriage, career, health, finance, legal ya personal outcomes promise nahi karta." },
        { title: "Module limitations", body: "Held ya beta modules unavailable ho sakte hain. Practical judgment aur qualified help zaroori ho sakti hai." },
    ...
    disclaimer: {
      ...
      badge: "Important",
      highlights: ["Promised outcomes nahi", "Medical, legal, financial ya psychological advice nahi", "Critical decisions practical review maangte hain"],
      sections: [
        { title: "Guidance scope", body: "Naksharix par astrology, numerology, tarot aur report guidance reflection, spiritual insight aur general guidance ke liye hai." },
        ...
        { title: "Held modules", body: "AI Astrologer aur doosre held modules is phase me production guidance surface nahi hain." }
      ],
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <h1 className="mt-3 font-cinzel text-4xl font-black text-[#1F2933] sm:text-5xl">{data.title}</h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-[#6B7280]">{data.intro}</p>
            <div className="mt-6 flex flex-wrap gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#D8AF66]/35 bg-[#F7EAD3]/80 px-4 py-2 text-sm font-semibold text-[#B8862E]">
          ...
          <Card className="border-[#E7D8BE] bg-white/90">
            <CardHeader>
              <CardTitle className="font-cinzel text-[#1F2933]">{data.ctaTitle}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="leading-7 text-[#6B7280]">{data.ctaBody}</p>
              <div className="rounded-lg border border-[#E7D8BE] bg-[#FFF9F0]/80 p-4">
                <p className="text-xs uppercase tracking-[0.18em] text-[#6B7280]">{data.emailLabel}</p>
                <p className="mt-2 font-semibold text-[#1F2933]">{supportEmail}</p>
              </div>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {data.highlights.map((item) => (
            <Card key={item} className="border-[#E7D8BE] bg-white/86">
              <CardContent className="p-5">
                <ShieldCheck className="h-5 w-5 text-[#00f5a0]" />
                <p className="mt-3 text-sm leading-6 text-[#1F2933]">{item}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="mt-10 grid gap-5">
          {data.sections.map((section) => (
            <Card key={section.title} className="border-[#E7D8BE] bg-white/88">
              <CardContent className="p-6">
                <h2 className="font-cinzel text-2xl font-bold text-[#1F2933]">{section.title}</h2>
                <p className="mt-3 leading-7 text-[#6B7280]">{section.body}</p>
                {section.bullets?.length ? (
                  <ul className="mt-4 grid gap-2 text-sm text-[#6B7280]">
...
function ContactFoundationForm({ form }: { form: NonNullable<TrustCopy["form"]> }) {
  return (
    <Card className="mt-10 border-[#E7D8BE] bg-white/90">
      <CardHeader>
        <CardTitle className="font-cinzel text-[#1F2933]">{form.title}</CardTitle>
        <p className="text-sm text-[#6B7280]">{form.note}</p>
      </CardHeader>
      <CardContent>
        <form className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <Label>{form.name}</Label>
            <Input className="border-[#E7D8BE] bg-white" />
          </div>
          <div className="space-y-2">
            <Label>{form.email}</Label>
            <Input type="email" className="border-[#E7D8BE] bg-white" />
          </div>
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Textarea className="min-h-32 border-[#E7D8BE] bg-white" />
          </div>
