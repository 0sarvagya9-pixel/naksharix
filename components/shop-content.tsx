...
function shopLabels(locale: "en" | "hi" | "hinglish") {
  if (locale === "hi") {
    return {
      ...
      safeCatalogueCopy: "यहाँ cart या checkout active नहीं है। Product request WhatsApp/contact support के माध्यम से handled होगी।",
  ...
  if (locale === "hinglish") {
    return {
      ...
      safeCatalogueCopy: "Cart ya checkout active nahi hai. Product request WhatsApp/contact support ke through handle hogi.",
      categoryCopy: "Premium spiritual catalogue category.",
  ...
  return {
    ...
    requestGuidance: "Request Guidance",
    safeCatalogue: "Safe catalogue mode",
    safeCatalogueCopy: "No cart or checkout is active here. Product requests are handled through WhatsApp/contact support.",
    categoryCopy: "Premium spiritual catalogue category.",
    viewProducts: "View Products",
    searchPlaceholder: "Search products...",
    allCategories: "All categories",
