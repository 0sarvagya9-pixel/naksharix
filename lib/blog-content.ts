export const blogPosts = [
  {
    ...
    description: "Learn how Naksharix personalizes daily horoscope readings using birth context, astrology timing, and AI guidance.",
    category: "horoscope",
    tags: ["Daily Horoscope", "Personalized Horoscope", "Horoscope"],
    body: "Personalized horoscope generation combines sign-level timing, birth context, current transits, and an AI writing layer that turns symbolic patterns into practical guidance."
  },
  {
  ...
  },
  {
    ...
    category: "tarot",
    tags: ["Tarot Reading", "Daily Tarot", "AI Tarot"],
    body: "Tarot works best as a structured reflection tool. AI interpretation should support agency, identify options, and avoid turning uncertainty into false certainty."
  }
] as const;
...
export const blogCategories = [
  ...
  { slug: "tarot", name: "Tarot", description: "Tarot reading prompts, spreads, AI interpretation, and reflective decision guides." },
