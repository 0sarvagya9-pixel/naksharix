...
export const seoLandingPages: SeoLandingPage[] = [
  {
    slug: "astrology",
    keyword: "Astrology",
    title: "Astrology Platform for Cosmic Guidance",
    description: "Explore Naksharix Astrology for horoscope, kundli, numerology, tarot reading, panchang, remedies, and premium cosmic reports.",
    h1: "Premium Astrology Guidance",
    intro: "Naksharix brings modern product design to traditional astrology workflows, helping users understand timing, personality, compatibility, daily rituals, and cosmic opportunities.",
    path: "/astrology",
    icon: WandSparkles,
    related: ["Horoscope", "Kundli", "Numerology", "Tarot Reading", "Panchang"],
    faqs: [
      { question: "What is Naksharix Astrology?", answer: "Naksharix Astrology combines horoscope, kundli, tarot, numerology, panchang, and report workflows in one premium astrology platform." },
      { question: "Is the astrology guidance personalized?", answer: "Naksharix can use birth details and preferences where the calculator or reviewed report workflow supports them." }
    ]
  },
  {
    slug: "horoscope",
    ...
    faqs: [
      ...
      { question: "Does Naksharix support personalized horoscope?", answer: "Static horoscope pages are content-based. Birth-chart personalization belongs to Kundli and reviewed report workflows." }
    ]
  },
  {
    slug: "kundli",
  ...
  },
  {
    ...
    title: "Tarot Reading with Interactive Spreads",
    description: "Try Naksharix Tarot Reading for daily tarot, love tarot, career tarot, three-card spreads, and reflective card meanings.",
    h1: "Tarot Reading",
    intro: "Draw animated tarot spreads and review reflective card meanings for daily guidance, love, career, choices, and personal clarity.",
    path: "/tarot",
    icon: Sparkles,
    ...
    faqs: [
      ...
      { question: "Are tarot meanings generated by the active AI Astrologer?", answer: "No. AI Astrologer remains on hold; tarot stays reflective and non-diagnostic." }
    ]
  },
  {
    slug: "panchang",
